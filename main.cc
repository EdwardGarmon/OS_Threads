...
void multRange(int num1[], int num2[], int product[], int workIndex1, int workIndex2, int id)
{	

	credit[workIndex1 + workIndex2 + 1] = id;
	product[workIndex1 + workIndex2 + 1 ]  += num1[workIndex1] * num2[workIndex2];
...
void *threadMultiply(void *arg)
{
	...
	while (true)
	{
		...
		multRange(num1, num2, product, workIndex1, workIndex2,id);
	}
}
